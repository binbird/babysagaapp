...
public class PhotoActivity extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		positionActivity=(String) getIntent().getExtras().get("windows");  
		...
		btn_sure.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent=null;
				if(positionActivity.equals("1")){
					//宝贝作息
					intent = new Intent(PhotoActivity.this,AddWandrActivity.class);
				}else if(positionActivity.equals("2")){
					//生活片段
					intent = new Intent(PhotoActivity.this,AddLifeActivity.class);
				}
				
				//Intent intent = new Intent(PhotoActivity.this,CompleteScheduleActivity.class);
				intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				intent.putExtra("piclist", paths);
