...
public class PhotoAlbumActivity extends Activity{
	...
	private static final String[] STORE_IMAGES = {
			MediaStore.Images.Media.DISPLAY_NAME, // 显示的名名称
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		positionActivity=intent.getStringExtra("position");  
		Toast.makeText(PhotoAlbumActivity.this, positionActivity, 3000).show();
	}
	...
	OnItemClickListener aibumClickListener =  new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view,
			...
			intent.putExtra("windows", positionActivity);
