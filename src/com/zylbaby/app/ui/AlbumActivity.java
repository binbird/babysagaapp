...
import com.zylbaby.app.adapter.AlbumGridViewAdapter;
import com.zylbaby.app.util.AlbumHelper;
import com.zylbaby.app.util.Bimp;
import com.zylbaby.app.util.FileUtils;
import com.zylbaby.app.util.ImageBucket;
...
public class AlbumActivity extends Activity {
	...
	private class AlbumSendListener implements OnClickListener {
		public void onClick(View v) {
			...
			intent.setClass(mContext, AddWandrActivity.class);
			startActivity(intent);
			finish();
		}
				...
				.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
					...
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (isChecked) {
							...
							File file  = FileUtils.saveBitmap(dataList.get(position).getBitmap(), fileName);
							dataList.get(position).setFile(file);
