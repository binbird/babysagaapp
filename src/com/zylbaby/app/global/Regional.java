...
public class Regional {
	//市，自治区集合
  	public int[] city = { R.array.beijin_province_item,
  	...
  	public int[] countyOfBeiJing = { R.array.beijin_city_item };
  	public int[] countyOfTianJing = { R.array.tianjin_city_item };
  	public int[] countyOfHeBei = { R.array.shijiazhuang_city_item,
  	...
  	public int[] countyOfShanXi1 = { R.array.taiyuan_city_item,
  	...
  	public int[] countyOfNeiMengGu = { R.array.huhehaote_city_item,
  	...
  	public int[] countyOfLiaoNing = { R.array.shenyang_city_item,
  	...
  	public int[] countyOfJiLin = { R.array.changchun_city_item,
  	...
  	public int[] countyOfHeiLongJiang = { R.array.haerbing_city_item,
  	...
  	public int[] countyOfShangHai = { R.array.shanghai_city_item };

  	public int[] countyOfJiangSu = { R.array.nanjing_city_item,
  	...
  	public int[] countyOfZheJiang = { R.array.hangzhou_city_item,
  	...
  	public int[] countyOfAnHui = { R.array.hefei_city_item,
  	...
  	public int[] countyOfFuJian = { R.array.huzhou_city_item,
  	...
  	public int[] countyOfJiangXi = { R.array.nanchang_city_item,
  	...
  	public int[] countyOfShanDong = { R.array.jinan_city_item,
  	...
  	public int[] countyOfHeNan = { R.array.zhenshou_city_item,
  	...
  	public int[] countyOfHuBei = { R.array.wuhan_city_item,
  	...
  	public int[] countyOfHuNan = { R.array.changsha_city_item,
  	...
  	public int[] countyOfGuangDong = { R.array.guangzhou_city_item,
  	...
  	public int[] countyOfGuangXi = { R.array.nanning_city_item,
  	...
  	public int[] countyOfHaiNan = { R.array.haikou_city_item,
  			R.array.sanya_city_item };
  	public int[] countyOfChongQing = { R.array.chongqing_city_item };
  	public int[] countyOfSiChuan = { R.array.chengdu_city_item,
  	...
  	public int[] countyOfGuiZhou = { R.array.guiyang_city_item,
  	...
  	public int[] countyOfYunNan = { R.array.kunming_city_item,
  	...
  	public int[] countyOfXiZang = { R.array.lasa_city_item,
  	...
  	public int[] countyOfShanXi2 = { R.array.xian_city_item,
  	...
  	public int[] countyOfGanSu = { R.array.lanzhou_city_item,
  	...
  	public int[] countyOfQingHai = { R.array.xining_city_item,
  	...
  	public int[] countyOfNingXia = { R.array.yinchuan_city_item,
  			R.array.shizuishan_city_item, R.array.wuzhong_city_item,
  			R.array.guyuan_city_item, R.array.zhongwei_city_item };
  	public int[] countyOfXinJiang = { R.array.wulumuqi_city_item,
  	...
  	public int[] countyOfHongKong = {};
  	public int[] countyOfAoMen = {};
  	public int[] countyOfTaiWan = {};
	...
	public ArrayAdapter<CharSequence> province_adapter;
	public ArrayAdapter<CharSequence> city_adapter;
	public ArrayAdapter<CharSequence> county_adapter;
	public void loadSpinner(Context fromcontext,final Spinner province_spinner,final Spinner city_spinner,
			final Spinner county_spinner) {
		context=fromcontext;
		...
		province_adapter = ArrayAdapter.createFromResource(context,
				...
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
						...
						if (true) {
							...
							if(strCity!=""){
								setSpinnerItemSelectedByValue(city_spinner,strCity);
							}
									...
									.setOnItemSelectedListener(new OnItemSelectedListener() {
										...
										public void onItemSelected(
											...
											if (true) {
												...
												if(strCounty!=""){
													setSpinnerItemSelectedByValue(county_spinner,strCounty);
												}
												county_spinner
														.setOnItemSelectedListener(new OnItemSelectedListener() {
...
//																		+ strCounty);
	...
	/*通过方法动态的添加适配器*/
	public void select(Spinner spin, ArrayAdapter<CharSequence> adapter,
			int arry) {
	...
	public static void setProvinceCityItemSelectedByValue(Spinner spinner,String value,String valuecity,String valuecountry){
		strCity=valuecity;
		strCounty=valuecountry;
		SpinnerAdapter apsAdapter= spinner.getAdapter(); //得到SpinnerAdapter对象
	    if(apsAdapter==null) return;
	    int k= apsAdapter.getCount();
	    for(int i=0;i<k;i++){
