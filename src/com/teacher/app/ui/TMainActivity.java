...
public class TMainActivity extends FragmentActivity implements OnClickListener{
	...
	//菜单标示
		...
		//菜单Fragment——Intent
		TScheduleFragment mSchedulefragment;
		TInfoFragment  mInfofragment;
		TClassFragment  mclassfragment;
		TMoreFragment  mMorefragment;
...
//	 	DisplayImageOptions options;
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			//网络连接判断
	        if(!NetWorkHelper.isNetworkAvailable(TMainActivity.this)){
	        	Toast.makeText(TMainActivity.this, R.string.network_not_connected, Toast.LENGTH_SHORT).show();
	        }
...
//			}
			...
			try {
				...
				mSchedulefragment.LoadData(0, s);
		...
		private void prepareView() {
			...
			ShowDate.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					Intent intent = new Intent(TMainActivity.this ,ShowCalendar.class);
		...
		private void prepareIntent() {
			mSchedulefragment = new TScheduleFragment();
			mInfofragment  = new TInfoFragment();
			mclassfragment  = new TClassFragment();
			mMorefragment  = new TMoreFragment();
		}
		...
		private void prepareFragment(){
	        ...
	        trans.add(R.id.content_frame,mSchedulefragment,TAB_TAG_HOME);
		...
		private void prepareActionbar(BabyBean babybean){
			...
			titleText.setText("教师账户:"+babybean.getBnickname());
			// 家长儿童头像图标，也可应用图标
		...
		public boolean onKeyDown(int keyCode, KeyEvent event) {
			if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction()==KeyEvent.ACTION_DOWN){
				if((System.currentTimeMillis()-exitTime) >2000){
					...
					//退出
					AppManager.getInstance().AppExit(TMainActivity.this);
					finish();
				}
				return true;
			}
		...
		public void onClick(View v) {
			...
			mBut3.setImageResource(R.drawable.main_class_1);
			...
			switch (checkedId) {
			case R.id.channel1:
				switchContent(mSchedulefragment,o);
			...
			case R.id.channel2:
				...
				break;
			case R.id.channel3:
				switchContent(mclassfragment,o);
				channel3.setBackgroundResource(R.drawable.main_down_transparent_black);
				mBut3.setImageResource(R.drawable.main_class_2);
			...
			final Handler handler = new Handler(){
				...
				public void handleMessage(Message msg) {
					if (msg.what == 1) {
						...
						pd.dismiss();
						UIHelper.ToastMessage(TMainActivity.this,msg.obj+"");
					} else if (msg.what == -1) {
						pd.dismiss();
						((AppException) msg.obj).makeToast(TMainActivity.this);
					}
				}
			};
			new Thread(){
