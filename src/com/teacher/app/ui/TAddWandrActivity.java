...
public class TAddWandrActivity extends BasePhotoActivity {
...
// 	final int SIGN = 0x11;
	...
	public void Init() {
		...
		adapter=new GridAdapter(TAddWandrActivity.this,handler);
		adapter.update();
		...
		noScrollgridview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (arg2 == Bimp.bmp.size()) {
					new PopupWindows(TAddWandrActivity.this, noScrollgridview,"");
				} else {
					Intent intent = new Intent(TAddWandrActivity.this,
							PhotoActivity.class);
	...
	private void init1() {
		...
		diarytype_showbtn.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				final DialogDiaryType Dlg=new DialogDiaryType(TAddWandrActivity.this,AppConstant.diarytype_array);
				//对话框中的返回事件
		...
		babystate_showbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				final DialogState Dlg= new DialogState(TAddWandrActivity.this);
		...
		add_start_date_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				datetimedialog.showTime(TAddWandrActivity.this, add_wandr_name_edit);
			}
		});
		//结束时间
		add_stop_date_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				datetimedialog.showTime(TAddWandrActivity.this, add_wandr_name1_edit);
			}
		});
		...
		add_select_date_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				datetimedialog.showDate(TAddWandrActivity.this, add_wandr_date_edit);
			}
		});
		...
		noScrollgridview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (arg2 == Bimp.bmp.size()) {
					//传入标识，返回到那个窗口
					new PopupWindows(TAddWandrActivity.this, noScrollgridview,"tadddiary");
				} else {
					Intent intent = new Intent(TAddWandrActivity.this,
							PhotoActivity.class);
					intent.putExtra("ID", arg2);
		...
		add_wandr_save_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (add_wandr_name_edit.getText().toString().equals("")) {
					UIHelper.ToastMessage(TAddWandrActivity.this, "任务开始时间不能为空！");
				} else {
					showDialog(SIGN);
					ShowPd();
...
//					});
					...
					wandrbean.setToUser(String.valueOf(babyid));
		...
		final Handler handler = new Handler() {
			public void handleMessage(Message msg) {
				if (msg.what == 1) {
					...
					pd.dismiss();
					if (user != null) {
						UIHelper.ToastMessage(TAddWandrActivity.this,
								"添加成功");
						//保存成功后，清除图片
						Bimp.bmp.clear();
						Bimp.drr.clear();
...
//						Intent intent = new Intent(); 
					...
					pd.dismiss();
					((AppException) msg.obj).makeToast(TAddWandrActivity.this);
				}
			}
		};
		new Thread() {
