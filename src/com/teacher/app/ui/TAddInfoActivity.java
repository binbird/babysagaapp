...
public class TAddInfoActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnsend.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				{
					Toast.makeText(TAddInfoActivity.this, "请输入内容", Toast.LENGTH_SHORT).show();
				}
			}
		});
...
//						   "添加失败" + msg.obj);
					Toast.makeText(TAddInfoActivity.this, "发送成功", Toast.LENGTH_SHORT).show();
					text.setText("");
					//判断是教师的列表，还是班级的列表
					ListInfoItem(0,touser);
				} else if (msg.what == -1) {
		...
		final Handler handler = new Handler() {
			public void handleMessage(Message msg) {
				...
				if (msg.what == 1) {
					...
					Toast.makeText(TAddInfoActivity.this, "获取数据失败0", Toast.LENGTH_SHORT).show();
				} else if (msg.what == 0) {
...
//						k=0;
//					}
					InfoItemAdapter myAdpter =new InfoItemAdapter(TAddInfoActivity.this,listinfoitem,touser);
					...
					Toast.makeText(TAddInfoActivity.this, "获取数据失败-1", Toast.LENGTH_SHORT).show();
				}
			}
		};
		new Thread() {
			public void run() {
				...
				try {
					...
					AppContext ac = (AppContext) TAddInfoActivity.this.getApplication();
...
//		            jsonObject.put("day", Day);
		            ...
		            ArrayList<InfoItem> infoitemlist = ac.getTeacherInfoItemList(paramMap);
					// 发出HTTP request
		            String res="200";
		            if (res.equals("200")) {
						msg.what = 0;// 成功
